defmodule PredictorWeb.UIComponents do
  ...
  use Phoenix.VerifiedRoutes, endpoint: PredictorWeb.Endpoint, router: PredictorWeb.Router, statics: PredictorWeb.static_paths()
  ...
  attr :label, :string, required: true; attr :value, :string, required: true; attr :hint, :string, default: nil; attr :tone, :string, default: "slate"
  ...
  attr :last_update, DateTime, default: nil; attr :compact, :boolean, default: false
  ...
  attr :title, :string, required: true; attr :message, :string, required: true; attr :action, :string, default: nil; attr :href, :string, default: nil
  ...
  attr :fixture, :map, required: true; attr :recommendations, :list, required: true
  ...
  def scanner_state(dt), do: if(DateTime.diff(DateTime.utc_now(), dt, :minute) > 60, do: "delayed", else: "running")
  ...
  defp tone_text("emerald"), do: "text-emerald-700"; defp tone_text("rose"), do: "text-rose-700"; defp tone_text("amber"), do: "text-amber-700"; defp tone_text(_), do: "text-slate-950"
  defp badge_class(s) when s in ["running", "scheduled", "placed", "won", "settled"], do: "bg-emerald-50 text-emerald-700"
